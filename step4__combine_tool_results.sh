...
do
 ...
 python3 tool_comparison/scripts/compute_truth_set_tsv_for_comparisons.py \
  ...
  mv ./tool_comparison/${results_folder}/STR_truthset.v1.variants.for_comparison.tsv.gz ./tool_comparison/${results_folder}/STR_truthset.v1.for_comparison.tsv.gz
  ...
  do
      ...
      mv ./tool_comparison/${results_folder}/STR_truthset.v1.for_comparison.with_${tool}_results.tsv.gz ./tool_comparison/${results_folder}/STR_truthset.v1.for_comparison.tsv.gz
      mv ./tool_comparison/${results_folder}/negative_loci.for_comparison.with_${tool}_results.tsv.gz ./tool_comparison/${results_folder}/negative_loci.for_comparison.tsv.gz
  done
