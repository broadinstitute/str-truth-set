...
mv ./tool_comparison/results/STR_truthset.v1.variants.for_comparison.with_ExpansionHunter_results.tsv.gz ./tool_comparison/results/STR_truthset.v1.for_comparison.tsv.gz
...
python3 tool_comparison/scripts/add_tool_results_columns.py \
  ...
  ./tool_comparison/results/STR_truthset.v1.for_comparison.tsv.gz
...
mv ./tool_comparison/results/STR_truthset.v1.for_comparison.with_GangSTR_results.tsv.gz ./tool_comparison/results/STR_truthset.v1.for_comparison.tsv.gz
...
mv ./tool_comparison/results/STR_truthset.v1.for_comparison.with_concordance.tsv.gz ./tool_comparison/results/STR_truthset.v1.for_comparison.tsv.gz
mv ./tool_comparison/results/STR_truthset.v1.for_comparison.with_concordance.alleles.tsv.gz ./tool_comparison/results/STR_truthset.v1.for_comparison.alleles.tsv.gz
...
mv ./tool_comparison/results/negative_loci.for_comparison.with_concordance.alleles.tsv.gz ./tool_comparison/results/negative_loci.for_comparison.alleles.tsv.gz

gunzip -f ./tool_comparison/results/STR_truthset.v1.for_comparison.tsv.gz
gunzip -f ./tool_comparison/results/negative_loci.for_comparison.tsv.gz
gunzip -f ./tool_comparison/results/STR_truthset.v1.for_comparison.alleles.tsv.gz
gunzip -f ./tool_comparison/results/negative_loci.for_comparison.alleles.tsv.gz
