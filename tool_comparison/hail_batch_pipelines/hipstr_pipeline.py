...
DOCKER_IMAGE = "us-central1-docker.pkg.dev/cmg-analysis/docker-repo/str-analysis-with-hipstr@sha256:2d1475e1b3f9471bc1655d5fa2bd3512dbd1a48a482a119da8aa8b110f021d38"
...
def create_hipstr_steps(bp, *, reference_fasta, input_bam, input_bai, regions_bed_file_paths, output_dir, output_prefix, reference_fasta_fai=None,
    ...
    #         behavior, and are also what the resource benchmark itself passes -- see BENCHMARK_TOOL_CONFIG["HipSTR"]
    #         in run_genotyping_tools.py, whose catalog is filtered to loci small enough that HipSTR stays lightweight).
    step1s = []
    step1_output_paths = []
