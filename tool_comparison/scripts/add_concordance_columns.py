...
def parse_args():
    ...
    p.add_argument("--tool", help="Which tool to compare to the true genotype", required=True,
        choices={"IlluminaExpansionHunter", "ExpansionHunter", "EHv5", "EHv5-bw2-optimized", "GangSTR", "HipSTR", "constrain", "TRGT", "LongTR", "inquiSTR", "vamos", "NewTruthSet"})
    p.add_argument("--compare-to", help="Which tool to compare to the true genotype", default="Truth",
        choices={"Truth", "IlluminaExpansionHunter", "ExpansionHunter", "EHv5", "EHv5-bw2-optimized", "GangSTR", "HipSTR", "constrain", "LongTR", "TRGT", "inquiSTR"})
