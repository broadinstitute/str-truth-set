...
def parse_args():
    ...
    p.add_argument("--tool", help="Which tool to compare to the true genotype", required=True,
        choices={"IlluminaExpansionHunter", "ExpansionHunter", "GangSTR", "HipSTR", "constrain", "TRGT", "LongTR", "inquiSTR", "NewTruthSet"})
    p.add_argument("--compare-to", help="Which tool to compare to the true genotype", default="Truth",
        choices={"Truth", "IlluminaExpansionHunter", "ExpansionHunter", "GangSTR", "HipSTR", "constrain", "LongTR", "TRGT", "inquiSTR"})
