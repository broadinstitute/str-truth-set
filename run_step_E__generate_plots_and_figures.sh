...
python3 -u plot_tool_accuracy_percent_exactly_right.py
python3 -u plot_tool_accuracy_percent_exactly_right.py --exclude-hipstr-no-call-loci
python3 -u plot_tool_accuracy_by_motif_size.py

python3 -u plot_tool_accuracy_vs_Q.py --verbose &
python3 -u plot_tool_accuracy_by_num_repeats.py --verbose &
wait
